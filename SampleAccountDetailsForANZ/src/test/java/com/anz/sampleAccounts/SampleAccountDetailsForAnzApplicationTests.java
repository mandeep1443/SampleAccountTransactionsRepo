...
/**
 * This is a test class created to test functionalities present in AccountTransactionsController Api
 * I have created positive and negative test cases for each of the functionalities
 * This test class should be run as SpringBootTest only, as I'm are not using mocking here.
 *  
...
class SampleAccountDetailsForAnzApplicationTests {
	...
	/**
	 * This test case is for testing the positive case of fetchAccountDetailsForUser service of AccountTransactionsController API
	 * Test scenario : When service is called with valid users
	 */
	@Test
	public void fetchAccountDetailsForValidUser() {
		...
		try {
			...
			List<Account> accountsForUser1 = accountsApi.fetchAccountDetailsForUser("user1");

			List<Account> accountsForUser2 = accountsApi.fetchAccountDetailsForUser("user2");
	...
	/**
	 * This test case is for testing the negative case of fetchAccountDetailsForUser service of AccountTransactionsController API
	 * Test scenario : When service is called with some invalid user for which no account exist.
	 */
	@Test
	public void fetchAccountDetailsForInvalidUser() {
		...
		try {
			accountsForUser1 = accountsApi.fetchAccountDetailsForUser("user3");
	...
	/**
	 * This test case is for testing the positive case of fetchAccountTransactions service of AccountTransactionsController API
	 * Test scenario : When service is called to fetch all transactions of selected valid account 
	 */
	@Test
	public void fetchAccountTransactionsForValidAccount() {
		logger.info("Start of test for fetchAccountTransactionsForValidAccount");

		List<Transaction> accountTransactions = accountsApi.fetchAccountTransactions("user1", 585309209);
	...
	/**
	 * This test case is for testing the negative case of fetchAccountTransactions service of AccountTransactionsController API
	 * Test scenario : When service is called to fetch all transactions of selected Invalid account which does not exist  
	 */
	@Test
	public void fetchAccountTransactionsForInvalidAccount() {
		...
		List<Transaction> accountTransactions = accountsApi.fetchAccountTransactions("user1", 585309899);
